        ...
        initial="hidden" 
            ...
            variants={{
              ...
              <HText>
                ...
                <p className="my-5">Nulla porttitor accumsan tincidunt. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Nulla porttitor accumsan tincidunt. Nulla porttitor accumsan tincidunt. Nulla porttitor accumsan tincidunt. Donec sollicitudin molestie malesuada.</p> 
        </motion.div>
        {/* FORM AND IMAGE  */}
        <div className="mt-10 justify-between gap-8 md:flex">
            ...
            variants={{
                ...
                visible:{opacity:1, y:0}}
                    ...
                    target="_blank"
                    onSubmit={onSubmit}
                    action="https://formsubmit.co/tnchnkit@hotmail.com"
                    method="POST">
                ...
                <motion.div className="relative  basis-2/5"
                initial="hidden" 
                whileInView="visible" 
                viewport={{once:true, amount: 0.5}} 
